...
static u_int32_t print_pkt (struct nfq_data *tb)
{
	...
	if (ret >= 0){
        ...
        if (http_len > 0){
			...
			if(strncmp(http, "GET", 3) == 0 || strncmp(http, "POST", 4) == 0 || strncmp(http, "PUT", 3) == 0 || strncmp(http, "DELETE", 6) == 0 || strncmp(http, "PATCH", 5) == 0 || strncmp(http, "HEAD", 4) == 0 || strncmp(http, "OPTIONS", 7) == 0 || strncmp(http, "CONNECT", 7) == 0){
...
int main(int argc, char **argv)
{
	...
	host = (char*)malloc(sizeof(host_len));
